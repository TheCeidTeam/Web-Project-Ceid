$(() => {
    ...
    $('#submitButton').on('click', function (e) { 
       ...
       // console.log(maxage);
            ...
            console.log(Math.max.apply(Math, numbers)); //O PINAKAS NUMBERS EXEI TA NOYMERA
        ...
        console.log(thirdbucket);
        console.log(fourthbucket);
        console.log(fifthbucket);
        console.log(sixthbucket);
        console.log(seventhbucket);
        console.log(eightbucket);
        console.log(ninebucket);
        console.log(tenbucket);
    ...
    $('#submitButton1').on('click', function (e) { 
       ...
       var user={
         ...
         $( '#myhtml' ).html( `Max-Stale Percentage : ${maxper}%'\n' 
         Min-Fresh Percentage : ${minper}% `);
