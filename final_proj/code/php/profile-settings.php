...
?>
    ...
    <div id="page-content-wrapper">
      ...
      <a onclick="location.href='har-upload55.php';" class='home'> <i class="fa fa-home" id="home" aria-hidden="false"></i></a>
    ...
    <div class="container-fluid">
     <div class="leftbox">
        ...
        <i class="k fa fa-cog" id="tab1" aria-hidden="true"></i> 
       </a>
       <a onclick='tabs(1)' class='tab'>
        <i class="k fa fa-bar-chart" id="tab1" aria-hidden="true"></i> 
       </a>
     ...
     <div class="rightbox">
        ...
        <div class="stats tabShow">
           ...
           <?php
            ...
            $sql="SELECT  uploaddate FROM data WHERE useremail  = ? ORDER BY uploaddate desc";
            ...
            <br>
            <?php
            $sql="SELECT  * FROM data WHERE useremail  = ?";
            $stmt = $conn->prepare($sql);
            $useremail=$var1;
            $stmt->bind_param('s',$useremail );
            $stmt->execute();
