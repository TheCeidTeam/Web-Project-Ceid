...
var user = {
  ...
  {		var cnt=0;
    ...
    function domain_from_url(string1) {
        ...
        var result = string1.replace('http://','').replace('https://','').split(/[/?#]/)[0];
